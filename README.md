...
### Giai đoạn 1: Sinh dữ liệu mô phỏng Hà Nội
...
### Giai đoạn 2: Huấn luyện Mô hình XGBoost (Surrogate Model)
Mô hình này giúp dự báo sự thay đổi nhiệt độ trong nhà, đóng vai trò là "máy giả lập" (Digital Twin/Surrogate Model) cho RL.
1. Mở file `XGB-DQN.ipynb`.
2. Chạy file để tiền xử lý dữ liệu từ `Cleaned_data.csv` thành `Cleaned_data_encode.csv` và huấn luyện mô hình XGBoost.
